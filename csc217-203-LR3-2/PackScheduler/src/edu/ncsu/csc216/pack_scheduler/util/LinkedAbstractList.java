...
/**
 * LinkedAbstractList that creates a list using ListNodes which have data and a pointer to next 
 * has basic methods for size, add, removing, setting and getting 
 * @author Preeti Joshi
 * @author Diya Patel
