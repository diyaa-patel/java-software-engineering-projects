 ...
 * and have getters and setters for name, section, credits, and instructorId. 
 * it also extends all the methods in Activity 
 * @author Diya Patel 
 */
public class Course extends Activity implements Comparable<Course> {
	...
	public Course(String name, String title, String section, int credits, String instructorId, int enrollmentCap, String meetingDays,
		...
		this.nameValidator = new CourseNameValidator();
		setName(name);
		setSection(section);
		setCredits(credits);
	 ...
	 * @param credits      credit hours for Course
	 * @param instructorId instructor's unity id
	 * @param enrollmentCap cap number of students per class
	 * @param meetingDays  meeting days for Course as series of chars
	 */
	public Course(String name, String title, String section, int credits, String instructorId, int enrollmentCap, String meetingDays) {
	 ...
	 /**
     * Returns the Course's CourseRoll.
...
//	}*/
	 ...
	 * @throws IllegalArgumentException with the message "Invalid section." if 
	 ...
	 * @throws IllegalArgumentException with the message "Invalid credits." if credits is less than the minimum
	 ...
	 * @throws IllegalArgumentException with the message "Invalid instructor id." if the param is null or empty. 
	 */
	public void setInstructorId(String instructorId) {
	    if ("".equals(instructorId) && instructorId.length() == 0) {
	...
	public String[] getShortDisplayArray() {
		...
		shortDisplay[4] = String.valueOf(roll.getOpenSeats());
	 ...
	 * @return longDisplay an array containing the given fields above 
	 */
	@Override
	 ...
	 * @throws IllegalArgumentException if the meetingString is invalid or the meeting days and times are invalid
	 */
	@Override 
...
//   * @throws IllegalArgumentException if there is an invalid meeting string 
//	 */
//	@Override 
...
//	}
	 ...
	 * @throws IllegalArgumentException if the activity is not a Course 
	 */
...
//			if(getName().equals(other.getName()) && getSection().equals(other.getSection())) {
//				return true; 
//			}
//		}
//		return false; 
	 ...
	 * @param c the course we are comparing to 
	 * @return 0 if the two courses are equal in name and section 
	 */
	@Override
