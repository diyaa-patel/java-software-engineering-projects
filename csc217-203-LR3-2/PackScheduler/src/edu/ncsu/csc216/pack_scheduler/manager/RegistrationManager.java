...
public class RegistrationManager {
	 ...
	 * @return facultyDirectory a directory with faculty objects
	 */
...
//		return false;
		...
		User student = studentDirectory.getStudentById(id); 
		User faculty = facultyDirectory.getFacultyById(id); 
		if(student == null && registrar.getId().equals(id)) {
			student = registrar; 
		}
		else if(faculty == null && registrar.getId().equals(id)) {
			faculty = registrar; 
		}
		...
		else if(faculty != null && faculty.getPassword().equals(localHashPW)) {
			currentUser = faculty; 
			return true; 
		}
	 ...
	 * @param c Course the faculty has to be added to
	 ...
	 * @return true if Faculty is removed succesfully
	 * @throws IllegalArgumentException if user is not a Registrar
	 */
	 ...
	 * @throws IllegalArgumentException if user is not an instance of student 
	 */
	 ...
	 * @throws IllegalArgumentException if user isnt a student 
	 */
