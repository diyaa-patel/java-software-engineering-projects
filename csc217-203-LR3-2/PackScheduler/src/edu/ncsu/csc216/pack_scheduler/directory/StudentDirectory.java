...
//		System.out.println("!!!");
//		System.out.println(firstName + "-" + lastName + "-" + id + "-" + email);
//		System.out.println("!!!");
	 ...
	 * @throws IllegalArgumentException if there is an IOException caught 
	 */
	...
	/**
	 * Will get the student on the id parameter 
	 * @param id the student id 
	 * @return studentDirectory.get(i) the student with the matching id 
	 */
