...
//			validCourse11, validCourse12, validCourse13};
	 ...
	 * @throws java.lang.Exception when unable to reset files
	 */
	@Before
	 ...
	 */
	@Test
	public void testReadValidCourseRecordsWithFaculty() throws FileNotFoundException {
		SortedList<Course> courses = CourseRecordIO.readCourseRecords("test-files/starter_course_records.txt");
		assertEquals(13, courses.size());
	 ...
	 */
	@Test
	public void testWriteCourseRecords() throws IOException {
		...
		activities.add(new Course("CSC216", "Software Development Fundamentals", "601", 3, "jctetter", 10,  "A"));
