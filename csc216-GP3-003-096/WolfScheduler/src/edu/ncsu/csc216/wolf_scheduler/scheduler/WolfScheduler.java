 ...
 * and can get the scheduled activities, schedule title, course catalog and export the schedule  
 * it can also add/remove an event or course from the schedule 
 * @author Diya Patel 
 */
public class WolfScheduler {
				...
				for(int j = 0; j < schedule.size(); j++) {
					...
					if(course.getSection().equals(section)) {
						try {
							...
							//System.out.println("ConflictCourse:" + course.toString());
							//System.out.println("ConflictActivity:" + activity.toString());
	 ...
	 * @throws IllegalArgumentException if the event is a dulpicate or if there is a conflict 
	 */
